...
<head>
    ...
    <title>Changer mot de passe - Lokativ</title>
...
<body>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" action="{{ route('password_submit') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input id="Ancien_mot_de_passe" type="password" class="form-control @error('Ancien_mot_de_passe') is-invalid @enderror" name="Ancien_mot_de_passe" required>
                                                {{-- <span toggle="#Ancien_mot_de_passe" class="input-group-text ri-eye-fill field-icon toggle-Ancien_mot_de_passe"></span> --}}
  ...
  <script type="text/javascript">
   ...
   cacheViewPwd('Ancien_mot_de_passe');
