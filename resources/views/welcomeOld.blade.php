  ...
  <main id="main">
    ...
    <section id="compte" class="compte">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
              ...
              <strong>Choisissez un type de compte</strong>
            </div>

            <nav class="d-flex justify-content-center">

              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Compte personnel</a>
                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Compte entreprise</a>
              </div>

            </nav>

            <!-- DEBUT POUR COMPTE PERSONNEL -->
              ...
              <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <form class="mt-5">
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          <label for="inputEmail4">E-mail <strong style="color:red;">*</strong>
                          </label>
                          <input type="email" class="form-control" name="email" id="email" placeholder="E-mail" required>
                        </div>

                        <div class="form-group col-md-6">
                          <label for="inputEmail4">Téléphone <strong style="color:red;">*</strong>
                          </label>
                          <input type="text" class="form-control" name="telephone" id="telephone" placeholder="Téléphone" required>
                        </div>

                        <div class="form-group col-md-6">
                          <label for="inputPassword4">Pièce d'identité ou Passport ou CIP <strong style="color:red;">* (png,jpeg )</strong>
                          </label>
                          <input type="file" class="form-control" name="identite" id="identite" placeholder="Pièce d'identité ou Passport ou CIP" required>
                        </div>

                        <div class="form-group col-md-3">
                          <label for="inputPassword4">Mot de passe <strong style="color:red;">*</strong>
                          </label>
                          <input type="password" class="form-control" id="mot_de_passe" name="mot_de_passe" placeholder="Mot de passe" required>
                        </div>

                        <div class="form-group col-md-3">
                          <label for="inputPassword4">Répéter mot de passe <strong style="color:red;">*</strong>
                          </label>
                          <input type="password" class="form-control" id="Confirmer_mot_de_passe" name="Confirmer_mot_de_passe" placeholder="Répéter mot de passe" required>
                        </div>

                      </div>
                      
                      <button type="submit" class="btn sbg1">Créer</button>
                    </form>

              </div>
              <!-- FIN POUR COMPTE PERSONNEL -->

                <!-- DEBUT POUR COMPTE ENTREPRISE -->
                        ...
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-8">
                                <form>
                                    ...
                                    <div class="tab">
                                      <h3 class="card-title d-flex justify-content-center">Information sur l'entreprise</h3>

                                        <p class="mt-4">
                                          <input placeholder="Nom de l'entreprise" oninput="this.className = ''" name="nom_entreprise" id="nom_entreprise">
                                        </p>


                                        <p>
                                            <label>Uploadez votre RCCM <strong style="color:red;">* (png,jpeg,pdf)</strong>
                                            </label>
                                         <input placeholder="Uploadez votre RCCM" type="file" oninput="this.className = ''" name="document_rccm"  id="document_rccm">
                                        </p>

                                        <p>
                                            <label>Uploadez votre IFU <strong style="color:red;">* (png,jpeg,pdf)</strong>
                                            </label>
                                         <input placeholder="Uploadez votre IFU" type="file" oninput="this.className = ''" name="document_ifu"  id="document_ifu">
                                        </p>

                                        <label>Numéro de la pièce d'identité du dirigeant <strong style="color:red;">* (png,jpeg,pdf)</strong>
                                        </label>
                                        <div class="input-group">
                                          <div class="input-group-prepend">
                                            <span class="input-group-text">Type de pièce</span>
                                          </div>
                                           <select required name="type_identite"  id="type_identite">
                                               <option selected value="" disabled>Choisissez un type</option>
                                               <option value="Carte d'identité">Carte d'identité</option>
                                               <option value="Carte biométrique">Carte biométrique</option>
                                               <option value="CIP">CIP</option>
                                               <option value="Passport">Passport</option>
                                           </select>
                                          <input type="text" class="form-control" name="numero_identite" id="numero_identite" required>
                                        </div>

                                        <div class="input-group">
                                          <p>
                                              <label>Uploadez votre carte<strong style="color:red;">* (png,jpeg,pdf)</strong>
                                              </label>
                                           <input placeholder="Uploadez votre carte" type="file" oninput="this.className = ''" name="document_carte"  id="document_carte">
                                          </p>
                                      </div>
                                    </div>
                                    ...
                                    <div class="tab">
                                        <div class="form-row">
                                        <div class="form-group col-md-6">
                                          <label for="inputEmail4">Nom du représentant<strong style="color:red;">*</strong>
                                          </label>
                                          <input type="text" class="form-control" name="nom_representant" id="nom_representant" placeholder="Nom du représentant" required>

                                        </div>

                                        <div class="form-group col-md-6">
                                          <label for="inputEmail4">Prénom du représentant
                                            <strong style="color:red;">*</strong>
                                          </label>
                                          <input type="text" class="form-control" name="prenom_representant" id="prenom_representant"placeholder="Prénom du représentant" required>
                                        </div>

                                        <div class="form-group col-md-6">
                                          <label for="inputEmail4">E-mail <strong style="color:red;">*</strong>
                                          </label>
                                          <input type="email" class="form-control" name="email_entreprise" id="email_entreprise" placeholder="E-mail" required>
                                        </div>

                                        <div class="form-group col-md-6">
                                          <label for="inputEmail4">Téléphone du représentant<strong style="color:red;">*</strong>
                                          </label>
                                          <input type="text" class="form-control" name="telephone_representant" id="telephone_representant" placeholder="Téléphone du représentant" required>
                                        </div>
                                    ...
                                    <div style="overflow:auto;" id="nextprevious">
                                        <div style="float:right;"> <button type="button" id="prevBtn" onclick="nextPrev(-1)">Précèdent</button> <button type="button" id="nextBtn" onclick="nextPrev(1)">Suivant</button> </div>
                                    </div>
                                </form>
                            </div>
                        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              <h3>Plan essai</h3>
              <h4><sup>xof</sup>0<span>pour 1 mois</span></h4>
              <ul>
                <li><i class="bx bx-check"></i> Un compte personnel pourra ajouter au plus 2 maisons</li>
                <li><i class="bx bx-check"></i> Un compte entreprise pourra ajouter au plus 5 maisons</li>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              <h3>Plan d'entreprise</h3>
              <h4><sup>xof</sup>250.000<span>par an</span></h4>
              <ul>
                <li><i class="bx bx-check"></i> Quam adipiscing vitae proin</li>
                <li><i class="bx bx-check"></i> Nec feugiat nisl pretium</li>
                <li><i class="bx bx-check"></i> Nulla at volutpat diam uteera</li>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>FAQ</h2>
          <p>Quelques questions que les clients nous posent parfois.</p>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Vous pouvez nous écrire ou appeler directement pour avoir plus de renseignement à propos de notre outils</p>
        </div>
