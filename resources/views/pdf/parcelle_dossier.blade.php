...
<h1 style="padding: 10px;"><u>Liste des dossiers des parcelles déjà traité du {{ Carbon\Carbon::parse($element2['date_debut'])->format('d/m/Y') }} au {{ Carbon\Carbon::parse($element2['date_fin'])->format('d/m/Y') }} </u></h1>
