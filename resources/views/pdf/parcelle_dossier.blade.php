...
<head>
    <meta charset="UTF-8">
    <title>Dossiers parcelles</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="header">
    <h1>LISTE DES DOSSIERS PARCELLES TRAITES</h1>
...
<div class="info-box">
    <p><strong>Document:</strong> Rapport des dossiers parcelles</p>
...
<table>
    <thead>
        <tr>
            ...
            <th style="width: 15%;">Proprietaire</th>
            <th style="width: 11%;">Telephone</th>
            <th style="width: 14%;">Quartier</th>
            <th style="width: 10%;">Superficie</th>
            <th style="width: 14%;" class="amount">Prix</th>
            <th style="width: 14%;">Acheteur</th>
            <th style="width: 12%;">Date cloture</th>
        </tr>
    </thead>
    <tbody>
...
<div class="footer">
    <p>Document de synthese des dossiers parcelles traites.</p>
