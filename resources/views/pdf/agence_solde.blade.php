...
<h1 style="padding: 10px;"><u>Bénéfice réalisé chez {{ $element2['proprio_nom'] }}  {{ $element2['proprio_prenom'] }} du {{ Carbon\Carbon::parse($element2['date_debut'])->format('d/m/Y') }}  au {{ Carbon\Carbon::parse($element2['date_fin'])->format('d/m/Y') }} </u></h1>
