...
<section class="section dashboard">
    ...
    <div class="modal fade" id="AjouterPrix" tabindex="-1" data-bs-backdrop="false">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="row g-3" method="post" action="javascript:save_prix();" 
               id="formulaire">
               @csrf
      ...
      <div class="row">
        <div class="col-lg-12">
              @can('ajoute-prix')
                <button type="button" class="btn sbg1 rounded-pill ri-money-euro-box-fill shadow" data-bs-toggle="modal" data-bs-target="#AjouterPrix">+</button> <br/><br/>
              @endcan
	    ...
	    <div class="modal-dialog modal-dialog-centered">
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
                  ...
                  <input type="hidden" name="maison_id22" class="form-control" id="maison_id" value="{{ $items->maison_id }}">
	  ...
	  <div class="modal fade" id="modifier{{$loop->iteration}}" tabindex="-1">
	    <div class="modal-dialog modal-dialog-centered">
	      <div class="modal-content">
            ...
            <form class="row g-3" method="post" action="{{ route('update_prix') }}" 
               id="formulairererree">
               @csrf

               <input type="hidden" name="prix_id" class="form-control" id="id" value="{{ $items->id }}">
...
<script>
  ...
  $('#nom_maison').on('change',function(e)
  {
    ...
    else
    {
        return $.ajax
        ({
            url: '{{ url('gerer-prix/numero_chambre') }}',
  ...
  $('#numero_chambre').on('change',function(e)
  {
    ...
    else
    {
        return $.ajax
        ({
            url: '{{ url('gerer-prix/type_chambre') }}',
