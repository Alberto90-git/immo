...
$.validator.addMethod("minAge", function(value, element, min) {
    ...
    function togglePassword(fieldId) {
        ...
        var icon = document.getElementById('togglePasswordIcon' + fieldId.charAt(0).toUpperCase() + fieldId.slice(1));
    ...
    document.getElementById('password_confirmation').addEventListener('input', confirmPasswordMatch);
    ...
    function confirmPasswordMatch() {
        ...
        var confirmationBadge = document.getElementById('confirmationBadge');

        if (password === passwordConfirmation) {
            confirmationBadge.style.backgroundColor = "green";
            confirmationBadge.textContent = "Passwords Match";
        } else {
            confirmationBadge.style.backgroundColor = "red";
            confirmationBadge.textContent = "Passwords Do Not Match";
        }
    }
